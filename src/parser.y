...
%token T_REPORT T_ADD_PAYOFF T_THERE_IS_A_CHANCE T_USUALLY T_GENERATE_CASES T_VALIDATE_CASES T_EQUAL_GREATER T_SAVE_DATABANK T_OPEN_DATABANK
%token T_AND_AND T_OR_OR T_IMPOSSIBLE T_ESTIMATE_CASES T_CONSIDER
